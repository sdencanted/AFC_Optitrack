  ...
  # Initialize the joysticks
    ...
    with SyncCrazyflie(URI, cf = Crazyflie(rw_cache = './cache')) as scf:
        ...
        while time_end > time.time():
            ...
            fz_d = kpz * pz_err - kdz * vz + 40000 + I_term_z # 40000 is the robot weight dun change
            ...
            if count % 10 == 0:
                ...
                print("Error: ", px_err, py_err, pz_err - offset_z)
                print('fz_d:', fz_d)
                print('I term:', I_term_z)
            ...
            if button0 == 1:
               cf.commander.send_setpoint(px_s, py_s, 0.1, 10)
