...
class RealTimeProcessor(object):
    ...
    def data_unpack_vrpn(self, vrpn_data): # for 3 drones only
        # x1, y1, z1, qx1, qy1, qz1, qw1, x2, y2, z2, qx2, qy2, qz2, qw2, x3, y3, z3, qx3, qy3, qz3, qw3= struct.unpack("hhhhhhhhhhhhhhhhhhhhh", udp_data)

        self.px1 = vrpn_data['x']   # position px
        self.py1 = vrpn_data['y']   # position py
        self.pz1 = vrpn_data['z']   # position pz
        self.quat_x1 = float(vrpn_data['qx'] )
        self.quat_y1 = float(vrpn_data['qy'] )
        self.quat_z1 = float(vrpn_data['qz'] )
        self.quat_w1 = float(vrpn_data['qw'] )
